                                        ...
                                        <td class="content-cell">
                                            <div class="f-fallback">
                                              <div style="width: 100%; margin-bottom: 10px; text-align: center;">
                                                <img src="<?= base_url('uploads/system/'.get_frontend_settings('dark_logo')); ?>" style="width: 300px;">
                                              </div>
                                              <h1 style="text-align: center; background-color: #f2f4f6; color: #2ec75e; padding: 20px; margin-bottom: 30px;"><?= $subject; ?></h1>
